...
頭骨は 13×8 のグリッドに側面図を**1 セルずつ手描き**しています（`TREX.skull`）。
ブロック 1 個が肋骨ロッドとほぼ同じ太さになる粒度で、周囲のボクセルと density を揃えてあります。
解剖学的な曲線をこのブロックサイズでサンプリングすると涙骨バー・後眼窩バー・眼窩上の骨梁
といった細い骨が消えて破綻するため、ドット絵として直接描くほうが確実でした。
長く低い吻部、巨大な前眼窩窓、高い位置の鍵穴形の眼窩、その後ろの側頭窓、深く角ばった後頭部。
角も鶏冠もありません。
